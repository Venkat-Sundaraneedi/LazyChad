...
function M.decorate(name, mod)
  ...
  setmetatable(mod, {
    __call = function(_, ...)
      ...
      LazyChad.deprecate("LazyChad." .. name, to)
    ...
    __index = function(_, k)
      if M.moved[name][k] then
        ...
        LazyChad.deprecate("LazyChad." .. name .. "." .. k, to)
...
function M.lazygit()
  LazyChad.deprecate("LazyChad.lazygit", "Snacks.lazygit")
  return Snacks.lazygit
end

function M.toggle()
  LazyChad.deprecate("LazyChad.toggle", "Snacks.toggle")
  return {
    map = function() end,
    wrap = function()
      return {}
