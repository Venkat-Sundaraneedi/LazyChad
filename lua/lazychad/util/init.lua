...
---@class lazychad.util: LazyUtilCore
---@field config LazyChadConfig
---@field ui lazychad.util.ui
---@field lsp lazychad.util.lsp
---@field root lazychad.util.root
---@field terminal lazychad.util.terminal
---@field format lazychad.util.format
...
---@field pick lazychad.util.pick
---@field cmp lazychad.util.cmp
local M = {}
...
function M.has_extra(extra)
  local Config = require("lazychad.config")
  local modname = "lazychad.plugins.extras." .. extra
...
for _, level in ipairs({ "info", "warn", "error" }) do
  M[level] = function(msg, opts)
    opts = opts or {}
    opts.title = opts.title or "LazyChad"
