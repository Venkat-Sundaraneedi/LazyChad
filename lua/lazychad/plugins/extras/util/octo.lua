return {
  ...
  { import = "lazychad.plugins.extras.lang.git" },
  ...
  -- Octo Picker
  {
    ...
    opts = function(_, opts)
      ...
      if LazyChad.has_extra("editor.telescope") then
        opts.picker = "telescope"
      elseif LazyChad.has_extra("editor.fzf") then
        opts.picker = "fzf-lua"
      elseif LazyChad.has_extra("editor.snacks_picker") then
        opts.picker = "snacks"
      else
        LazyChad.error("`octo.nvim` requires `telescope.nvim` or `fzf-lua` or `snacks.nvim`")
      end
