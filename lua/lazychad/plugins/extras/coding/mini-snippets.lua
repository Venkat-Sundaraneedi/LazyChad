if lazychad_docs then
  ...
  vim.g.lazychad_mini_snippets_in_completion = true
...
local include_in_completion = vim.g.lazychad_mini_snippets_in_completion == nil
  or vim.g.lazychad_mini_snippets_in_completion
...
return {
  ...
  desc = "Manage and expand snippets (alternative to Luasnip)",
  {
    ...
    opts = function()
      ...
      LazyChad.cmp.actions.snippet_stop = function() end -- by design, <esc> should not stop the session!
      ---@diagnostic disable-next-line: duplicate-set-field
      LazyChad.cmp.actions.snippet_forward = function()
        return jump("next")
      end
